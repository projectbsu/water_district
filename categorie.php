      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            <input type="text" class="form-control" name="categorie-name" placeholder="Service Name">
          </div>
          <div class="form-group">
            <textarea class="form-control" name="categorie-details" placeholder="Category Details"></textarea>
          </div>
          <button type="submit" name="add_cat" class="btn btn-primary">Add Service Category</button>
        </form>
        </div>
      </div>
    </div>
